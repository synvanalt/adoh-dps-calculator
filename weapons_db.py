...
PURPLE_WEAPONS = {
    ...
    # DOUBLE-SIDED WEAPONS:
    'Dire Mace': {'slashing': [8, 6], 'magical': [2, 6], 'legendary': {'proc': 'on_crit', 'sonic': [2, 10]}},   # 10% phys immune, potential stun
    ...
    'Throwing Axes': {'sonic': [7, 6], 'massive': [1, 6]},  # On-hit Silence DC46/100%/1round

    # RANGED WEAPONS - AMMO-BASED:
    'Heavy Crossbow': {'bludgeoning': [2, 12], 'acid': [2, 8], 'magical': [1, 12], 'fire': [2, 6], 'massive': [2, 8], 'legendary': {'proc': 'on_crit', 'fire': [6, 6]}}, # On-crit Firebrand lvl 6
    'Light Crossbow': {'bludgeoning': [2, 12], 'acid': [2, 8], 'magical': [1, 12], 'cold': [1, 10], 'massive': [1, 10], 'legendary': {'proc': 'on_crit', 'cold': [6, 6]}}, # On-crit Coldbrand lvl 6
    'Longbow': {'bludgeoning': [2, 12], 'negative': [2, 8], 'magical': [1, 12], 'fire': [2, 6], 'massive': [2, 6], 'legendary': {'proc': 'on_crit', 'fire': [4, 6], 'pure': [4, 6]}},    # Was "Arrows"
    'Shortbow': {'bludgeoning': [2, 12], 'negative': [2, 8], 'magical': [1, 12], 'electrical': [1, 10], 'massive': [2, 8]}, # SoV extend by 5 rounds, SoV immune, Elec 10% immune
    'Sling': {'piercing': [2, 8], 'fire': [2, 8], 'pure': [2, 6], 'divine': [2, 6]},  # On-hit 5%: gain 20% movement speed for 30sec (can't stack)

    # MONK WEAPONS:
    'Gloves_Shandy': {'piercing': [2, 6], 'acid': [2, 6], 'magical': [2, 6], 'divine': [2, 6]},  # Legendary remove immunities
    'Gloves_Adam': {'slashing': [2, 8], 'pure': [2, 8], 'divine': [2, 8], 'sneak': [1, 6]},    # Doom - NEED MANUAL FIX
    'Kama': {'bludgeoning': [2, 8], 'divine': [2, 6], 'positive': [2, 6], 'legendary': {'proc': 0.05, 'effect': 'deep_cuts', 'damage': [2, 20]}},  # 4 regen, 5% neg & pos
    ...
    'Shuriken': {'bludgeoning': [2, 6], 'negative': [2, 6], 'pure': [2, 4], 'sneak': [2, 6]}, # On-hit 3%: gain 90% concealment for 1 round

    # MEDIUM WEAPONS:
    'Bastard Sword_Reaver': {'bludgeoning': [7, 6], 'cold': [2, 8]}, # 5% Cold imm, On-hit Slow DC42/100%/1round
    'Bastard Sword_Vald': {'bludgeoning': [2, 6], 'divine': [2, 6], 'magical': [2, 6], 'negative': [2, 6], 'sneak': [1, 6], 'legendary': {'proc': 0.05, 'pure': [10, 6]}}, # 2d6 Pure per second in 2.25 radius, lasts 5 seconds
    'Battleaxe': {'bludgeoning': [2, 8], 'magical': [2, 8], 'negative': [2, 8], 'vs_race_good': {'pure': [2, 12]}},  # Divine resist 5/-, Divine 5% immune
    'Dwarven Waraxe': {'bludgeoning': [2, 8], 'acid': [2, 10], 'negative': [2, 8], 'vs_race_dragon': {'pure': [4, 10], 'enhancement': 12}},    # +12 Enhancement vs. Dragons, Immunity Knockdown & Fear
    'Katana_Kin': {'bludgeoning': [7, 6], 'pure': [1, 10], 'legendary': {'proc': 0.10, 'physical': [2, 20]}},
    'Katana_Soul': {'bludgeoning': [2, 12], 'divine': [2, 6], 'sonic': [2, 8], 'legendary': {'proc': 0.10, 'fire': [2, 20]}}, # On-Hit Level Drain DC=44, 5% Divine+Sonic imm
    'Light Flail': {'slashing': [7, 6], 'pure': [2, 8], 'legendary': {'proc': 0.05, 'effect': 'sunder'}},  # sunder
    'Longsword': {'bludgeoning': [2, 8], 'cold': [2, 12], 'magical': [2, 6], 'vs_race_undead': {'piercing': [2, 6]}, 'legendary': {'proc': 'on_crit', 'cold': [4, 6], 'pure': [4, 6]}},  # Icy Veng, 2d6 pierce v. undead
    ...
    # SMALL\TINY WEAPONS:
    'Club_Fish': {'piercing': [2, 10], 'acid': [7, 6], 'legendary': {'proc': 0.05, 'acid': [4, 6], 'pure': [4, 6]}},  # Acid 20/-
    'Club_Stone': {'piercing': [2, 8], 'sonic': [7, 6], 'legendary': {'proc': 0.05, 'effect': 'crushing_blow'}},  # 5% reduce immunities by 5% for 2 rounds
    'Dagger_FW': {'bludgeoning': [2, 6], 'divine': [2, 4], 'acid': [2, 4], 'pure': [2, 4], 'legendary': {'proc': 0.02, 'physical': [0, 0, 300]}}, # [0, 3, 'physical']],  # Leg Last Words
    'Dagger_PK': {'bludgeoning': [2, 6], 'negative': [2, 6], 'massive': [0, 0, 80]}, # On-hit 5%: gain 90% concealment for 1 round
    'Handaxe_Adam': {'bludgeoning': [2, 8], 'divine': [2, 6], 'pure': [2, 4], 'sneak': [1, 6]}, # On-hit 5%: receive 5% phys immune 2 rounds (stacks)
    'Handaxe_Ichor': {'bludgeoning': [2, 6], 'negative': [2, 6], 'acid': [2, 8], 'legendary': {'proc': 0.05, 'acid': [4, 6], 'pure': [4, 6]}},  # 10% acid immune, on-hit poison
    'Kukri_Inconseq': {'bludgeoning': [2, 6], 'divine': [2, 6], 'magical': [2, 6], 'vs_race_good_evil': {'piercing': [1, 4]}, 'legendary': {'proc': 'on_crit', 'effect': 'inconsequence'}},  # Legend Effect TBD
    'Light Hammer': {'slashing': [2, 10], 'cold': [2, 12], 'magical': [1, 6], 'legendary': {'proc': 'on_crit', 'cold': [4, 6], 'pure': [4, 6]}},
    'Mace': {'slashing': [2, 12], 'electrical': [2, 12], 'pure': [1, 6], 'legendary': {'proc': 0.05, 'electrical': [4, 6], 'pure': [4, 6]}}, # call Thunder, on-hit Stun 44DC 50%/1round
    'Shortsword_Adam': {'bludgeoning': [2, 6], 'divine': [2, 6], 'pure': [2, 6]},   # On-hit 5%: receive 5% phys immune 2 rounds (stacks)
    'Shortsword_Cleaver': {'bludgeoning': [2, 6], 'acid': [2, 6], 'negative': [2, 6], 'massive': [2, 12]},  # 5% on-hit: target receives 5% miss chance (stacks), Vamp regen +5
    'Sickle': {'piercing': [2, 10], 'divine': [2, 10]},  # Creeping Doom +1000 dmg
